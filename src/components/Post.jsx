...
const Post = ({ item }) => {
  return (
    <div className="h-[400px] w-[300px] font-poppins shadow-md rounded-lg p-4 ">
      <img
        src={
          !item.urlToImage
      ...
      <h1 className="mb-5 mt-5 text-gray-600 ">
        {item.author ? item.author : "No Author"}
      </h1>

      <h1 className="font-extrabold">{item.title.slice(0, 48)}</h1>

      <div className="border border-black text-center mt-5 transition-all duration-500 hover:bg-black hover:text-white ">
